    ...
    <>
      ...
      <main className="flex-1 px-4 py-6 max-w-md mx-auto w-full flex flex-col gap-4">
        ...
        <p className="text-sm text-slate-500">
          Up ảnh chuyển khoản ngay, chưa cần điền số tiền/ngày gì cả — rảnh lúc nào thì gắn ảnh vào đúng khoản đã ghi,
          hoặc tạo khoản mới từ ảnh đó. Ảnh chưa gắn vẫn được lưu ở đây, không mất.
        </p>
